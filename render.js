...
(function () {
	...
	var unitSizes = {
		px : {
			...
			"ROUND" :  { profile: "ROUND", keySpacing: 3, bevelMargin: 1, bevelOffsetTop: 0, bevelOffsetBottom: 2, padding: 4, roundOuter: 24, roundInner: 24 },
		...
		mm : {
			...
			"ROUND" : {  profile: "ROUND", keySpacing: 0.4445, bevelMargin: 3.1115, padding: 0, roundOuter: 1.0, roundInner: 2.0 },
	...
	["px","mm"].forEach(function(unit) {
		["","DCS","DSA","SA","CHICKLET","ROUND","FLAT"].forEach(function(profile) {
	...
	function getProfile(key) {
		return (/\b(SA|DSA|DCS|OEM|CHICKLET|ROUND|FLAT)\b/.exec(key.profile) || [""])[0];
	}
